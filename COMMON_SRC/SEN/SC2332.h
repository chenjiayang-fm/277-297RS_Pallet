...
/* ID */
#define SC2332_CHIP_ID_HIGH_ADDR    (0x3107)
#define SC2332_CHIP_ID_LOW_ADDR     (0x3108)
#define SC2332_CHIP_ID              (0xcb17)

#define SC2332_EXPH                 (0x3E00)
#define SC2332_EXPM                 (0x3E01)
#define SC2332_EXPL                 (0x3E02)
#define SC2332_FRAME_LENGTH_H       (0x320E)
#define SC2332_FRAME_LENGTH_L       (0x320F)
#define SC2332_AGAIN                (0x3E08)
#define SC2332_AGAIN_F              (0x3E09)
#define SC2332_DGAIN                (0x3E06)
#define SC2332_DGAIN_F              (0x3E07)

#define SC2332_MIRROR               (0x06)
#define SC2332_FLIP		            (0x60)
//==============================================================================
// FUNCTION
//==============================================================================
//------------------------------------------------------------------------
