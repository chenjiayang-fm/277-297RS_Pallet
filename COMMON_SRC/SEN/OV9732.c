...
void SEN_PclkSetting(uint8_t ubPclkIdx)
{
    ...
    tAE_SensorPara.ulSensorPixelPerLine = 1478;
    tAE_SensorPara.ulSensorLinePerFrame = 802;
...
uint8_t ubSEN_SetSensorInitTable(void)
{
    ...
    if(ubSEN_CheckSensorState() != 1)
        return 0;
    printd(DBG_CriticalLvl, "OV9732 Sensor\n");
...
{
    sensor_cfg.ubSensorType = SEN_OV9732;	
