...
/* ID */
#define GC1084_CHIP_ID_HIGH_ADDR   (0x03F0)
#define GC1084_CHIP_ID_LOW_ADDR    (0x03F1)
#define GC1084_CHIP_ID             (0x1084)
#define GC1084_GAIN_L              (0x00B2)
#define GC1084_GAIN_H              (0x00B1)
#define GC1084_EXP_L               (0x0d04)
#define GC1084_EXP_H               (0x0d03)
#define GC1084_FRAME_L			       (0x0d42)
#define GC1084_FRAME_H			       (0x0d41)
//#define GC1084_PAGE_SEL			   (0xFE)


#define GC1084_MIRROR		           (0x1 << 0)
#define GC1084_FLIP		             (0x1 << 1)   
