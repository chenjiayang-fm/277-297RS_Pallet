...
// I2C slave ID can be programmed as 0x60/0x61, 0x64/0x65, 0x68/0x69 or 0x6C/0x6D for write and read.
#define SEN_SLAVE_ADDR           (0x40)
// system control registers
/* ID */
#define H66_CHIP_ID_HIGH_ADDR   (0x0A)
#define H66_CHIP_ID_LOW_ADDR    (0x0B)
#define H66_CHIP_ID             (0x0A66)
#define H66_GAIN                (0x00)
#define H66_EXP_L               (0x01)
#define H66_EXP_H               (0x02)
#define H66_FRAME_L			    (0x22)
#define H66_FRAME_H			    (0x23)

#define H66_MIRROR		        (0x1 << 5)
#define H66_FLIP		        (0x1 << 4)
//==============================================================================
// FUNCTION
//==============================================================================
//------------------------------------------------------------------------
