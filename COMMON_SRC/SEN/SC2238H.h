...
/* ID */
#define SC2238H_CHIP_ID_HIGH_ADDR    (0x3107)
#define SC2238H_CHIP_ID_LOW_ADDR     (0x3108)
#define SC2238H_CHIP_ID              (0x2315)

#define SC2238H_EXPH                 (0x3E00)
#define SC2238H_EXPM                 (0x3E01)
#define SC2238H_EXPL                 (0x3E02)
#define SC2238H_FRAME_LENGTH_H       (0x320E)
#define SC2238H_FRAME_LENGTH_L       (0x320F)
#define SC2238H_D_FRAME_LENGTH_H     (0x3235)
#define SC2238H_D_FRAME_LENGTH_L     (0x3236)
#define SC2238H_GAIN_H               (0x3E08)
#define SC2238H_GAIN_L               (0x3E09)

#define SC2238H_MIRROR               (0x06)
#define SC2238H_FLIP                 (0x60)
//==============================================================================
// FUNCTION
//==============================================================================
//------------------------------------------------------------------------
