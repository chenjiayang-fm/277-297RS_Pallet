/*!
	...
	\file		IMX462.c
	\brief		Sensor IMX462 relation function
	\author		BoCun
	\version	1.0
	\date		2020-11-24
...
const uint8_t ubSEN_InitTable[] = {
    /*
        ...
        But SEN_CLK = 120MHz/3 = 40MHz (close to 37.125MHz)
    ...
    */
    ...
    0x83, 0x30, 0x03, 0x00,
    0x83, 0x30, 0x04, 0x10,
    0x83, 0x30, 0x05, 0x00,         //ADBIT = 0
    0x83, 0x30, 0x07, 0x00,         //WINMODE = 0
    0x83, 0x30, 0x09, 0x12,         //FRSEL = 2h
    0x83, 0x30, 0x0A, 0x3C,         ////BLKLEVEL = 3Ch
    0x83, 0x30, 0x0B, 0x00,
    0x83, 0x30, 0x0C, 0x00,
    0x83, 0x30, 0x0E, 0xF0,         ////Set to "F0"
    0x83, 0x30, 0x0F, 0x00,         ////Set to "00"
    0x83, 0x30, 0x10, 0x21,         ////FPGC = 21h
    0x83, 0x30, 0x11, 0x02,         ////Set to "02"
    0x83, 0x30, 0x12, 0x64,         //Set to "64"
    0x83, 0x30, 0x13, 0x00,         //Set to "00"
    0x83, 0x30, 0x14, 0x00,
    0x83, 0x30, 0x16, 0x09,         ////Set to "09"
    //VMAX = 0x465 = 1125
    0x83, 0x30, 0x18, 0x65,
    0x83, 0x30, 0x19, 0x04,
    0x83, 0x30, 0x1A, 0x00,
...
//    0x83, 0x30, 0x1D, 0x11,
    ...
    0x83, 0x30, 0x43, 0x07,
    0x83, 0x30, 0x45, 0x01,
    0x83, 0x30, 0x46, 0x00,         //ODBIT = 0, OPORTSEL = 0
    0x83, 0x30, 0x48, 0x00,
    0x83, 0x30, 0x49, 0x08,
    0x83, 0x30, 0x4B, 0x00,
    0x83, 0x30, 0x4D, 0x00,         ////TRIG_TOUT_SEL = 0
    0x83, 0x30, 0x5C, 0x18,         //INCLSEL1 = 18h
    0x83, 0x30, 0x5D, 0x03,         //INCLSEL2 = 03h
    0x83, 0x30, 0x5E, 0x20,         //INCLSEL3 = 20h
    0x83, 0x30, 0x5F, 0x01,         //INCLSEL4 = 01h
    0x83, 0x30, 0x70, 0x02,         ////Set to "02"
    0x83, 0x30, 0x71, 0x11,         ////Set to "11"
    0x83, 0x30, 0x74, 0x00,
    0x83, 0x30, 0x75, 0x00,
    0x83, 0x30, 0x76, 0x00,
    0x83, 0x30, 0x77, 0x08,
    ...
    0x83, 0x30, 0x79, 0x00,
    0x83, 0x30, 0x7A, 0x00,
    0x83, 0x30, 0x9B, 0x10,         ////Set to "10"
    0x83, 0x30, 0x9C, 0x21,         ////Set to "21"
    0x83, 0x30, 0x9E, 0x4A,         ////Set to "4A"
    0x83, 0x30, 0x9F, 0x4A,         ////Set to "4A"
    0x83, 0x30, 0xA2, 0x02,         ////Set to "02"
    0x83, 0x30, 0xA6, 0x20,         ////Set to "20"
    0x83, 0x30, 0xA8, 0x20,         ////Set to "20"
    0x83, 0x30, 0xAA, 0x20,         ////Set to "20"
    0x83, 0x30, 0xAC, 0x20,         ////Set to "20"
    0x83, 0x30, 0xB0, 0x43,         ////Set to "43"
    0x83, 0x30, 0xB1, 0x00,
    0x83, 0x30, 0xB3, 0x12,
    0x83, 0x30, 0xC0, 0x10,
    0x83, 0x30, 0xF0, 0xF0,
    ...
    0x83, 0x31, 0x06, 0x00,
    0x83, 0x31, 0x0F, 0x03,
    0x83, 0x31, 0x19, 0x9E,         ////Set to "9E"
    0x83, 0x31, 0x1C, 0x1E,         ////Set to "1E"
    0x83, 0x31, 0x1E, 0x08,         ////Set to "08"
    0x83, 0x31, 0x28, 0x05,         ////Set to "05"
    0x83, 0x31, 0x29, 0x1D,         //ADBIT1 = 1Dh
    0x83, 0x31, 0x3D, 0x83,         ////Set to "83"
    0x83, 0x31, 0x50, 0x03,         ////Set to "03"
    0x83, 0x31, 0x53, 0x40,
    0x83, 0x31, 0x5E, 0x1A,         //INCLSEL5 = 1Ah
    0x83, 0x31, 0x64, 0x1A,         //INCLSEL6 = 1Ah
    0x83, 0x31, 0xA0, 0xFC,
    0x83, 0x31, 0xA1, 0x00,
    0x83, 0x31, 0x7C, 0x12,         //ADBIT2 = 12h
    0x83, 0x31, 0x7E, 0x00,         ////Set to "00"
    0x83, 0x31, 0xEC, 0x37,         //ADBIT3 = 37h

    0x83, 0x32, 0x57, 0x03,         ////Set to "03"
    0x83, 0x32, 0x64, 0x1A,         ////Set to "1A"
    0x83, 0x32, 0x65, 0x2B,         ////Set to "2B"
    0x83, 0x32, 0x66, 0x00,         ////Set to "00"
    0x83, 0x32, 0x6B, 0x10,         ////Set to "10"
    0x83, 0x32, 0x74, 0x2B,         ////Set to "2B"
    0x83, 0x32, 0x75, 0xA0,         ////Set to "A0"
    0x83, 0x32, 0x76, 0x02,         ////Set to "02"
    0x83, 0x32, 0xAA, 0x0D,         ////Set to "0D"
    0x83, 0x32, 0xB8, 0x50,         ////Set to "50"
    0x83, 0x32, 0xB9, 0x10,         ////Set to "10"
    0x83, 0x32, 0xBA, 0x00,         ////Set to "00"
    0x83, 0x32, 0xBB, 0x04,         ////Set to "04"
    0x83, 0x32, 0xC8, 0x50,         ////Set to "50"
    0x83, 0x32, 0xC9, 0x10,         ////Set to "10"
    0x83, 0x32, 0xCA, 0x00,         ////Set to "00"
    0x83, 0x32, 0xCB, 0x04,         ////Set to "04"
    0x83, 0x33, 0x2C, 0xD3,         ////Set to "D3"
    0x83, 0x33, 0x2D, 0x10,         ////Set to "10"
    0x83, 0x33, 0x2E, 0x0D,         ////Set to "0D"
    0x83, 0x33, 0x58, 0x06,         ////Set to "06"
    0x83, 0x33, 0x59, 0xE1,         ////Set to "E1"
    0x83, 0x33, 0x5A, 0x11,         ////Set to "11"
    0x83, 0x33, 0x60, 0x1E,         ////Set to "1E"
    0x83, 0x33, 0x61, 0x61,         ////Set to "61"
    0x83, 0x33, 0x62, 0x10,
    0x83, 0x33, 0xB0, 0x50,
    0x83, 0x33, 0xB2, 0x1A,
    0x83, 0x33, 0xB3, 0x04,
    ...
    0x83, 0x34, 0x05, 0x10,         //REPETITION = 1h
    0x83, 0x34, 0x07, 0x01,         //PHYSICAL_LANE_NUM = 1h
    0x83, 0x34, 0x10, 0x1A,
    0x83, 0x34, 0x14, 0x0A,         //OPB_SIZE_V = Ah
    0x83, 0x34, 0x15, 0x01,
    //Y_OUT_SIZE = 0x0449 = 1097
    0x83, 0x34, 0x18, 0x49,
    0x83, 0x34, 0x19, 0x04,
    0x83, 0x34, 0x41, 0x0A,         //CSI_DT_FMT = 0Ah
    0x83, 0x34, 0x42, 0x0A,         //CSI_DT_FMT = 0Ah
    0x83, 0x34, 0x43, 0x01,         //CSI_LANE_MODE = 1h
    0x83, 0x34, 0x44, 0x20,         //EXTCK_FREQ = 0x20
    0x83, 0x34, 0x45, 0x25,         //EXTCK_FREQ = 0x25
    0x83, 0x34, 0x46, 0x57,
    0x83, 0x34, 0x47, 0x00,         //TCLKPOST = 0x57
    0x83, 0x34, 0x48, 0x37,
    0x83, 0x34, 0x49, 0x00,         //THSZERO = 0x37
    0x83, 0x34, 0x4A, 0x1F,
    0x83, 0x34, 0x4B, 0x00,         //THSPREPARE = 0x1F
    0x83, 0x34, 0x4C, 0x1F,
    0x83, 0x34, 0x4D, 0x00,         //TCLKTRAIL = 0x1F
    0x83, 0x34, 0x4E, 0x1F,
    0x83, 0x34, 0x4F, 0x00,         //THSTRAIL = 0x1F
    0x83, 0x34, 0x50, 0x77,
    0x83, 0x34, 0x51, 0x00,         //TCLKZERO = 0x77
    0x83, 0x34, 0x52, 0x1F,
    0x83, 0x34, 0x53, 0x00,         //TCLKPREPARE = 0x1F
    0x83, 0x34, 0x54, 0x1C/*7*/,
    0x83, 0x34, 0x55, 0x00,         //TLPX = 0x17
    //X_OUT_SIZE = 0x079C = 1948
    0x83, 0x34, 0x72, 0x9C,
    0x83, 0x34, 0x73, 0x07,
    0x83, 0x34, 0x80, 0x49,         //INCLSEL7 = 49h
    //stanby cancel	
    0x83, 0x30, 0x00, 0x00,
    0x83, 0x30, 0x01, 0x00,
    0x83, 0x30, 0x02, 0x00,
...
uint8_t ubSEN_CheckSensorState(void)
{
    ...
    bSEN_I2C_Read (IMX462_CHIP_MODELID_ADDR, &pBuf[0]);
	if (IMX462_CHIP_MODELID != ubPID)
	{
		printd(DBG_ErrorLvl, "I2C read fail.<0x%x 0x%x>\n", IMX462_CHIP_MODELID, ubPID);
        return 0;
	}
    return 1;
}
...
uint8_t ubSEN_SetSensorInitTable(void)
{
    ...
    if(ubSEN_CheckSensorState() != 1)
        return 0;
    printd(DBG_CriticalLvl, "IMX462 Sensor\n");
...
void SEN_WrDummyLine(uint16_t uwDL)
{
    ...
    if(uwDL == uwOldDummy)  
        return;
    //Set Dummy Line
    bSEN_I2C_WriteTry(IMX462_FRAME_LENGTH_M, (uint8_t)((uwDL>>8) & 0x00ff), TRY_COUNTS);		
    bSEN_I2C_WriteTry(IMX462_FRAME_LENGTH_L, (uint8_t)((uwDL) & 0x00ff), TRY_COUNTS);	   
	uwOldDummy = uwDL;
}
...
void SEN_WrExpLine(uint16_t uwExpLine)
{
    ...
    if(uwTargetExpLine == uwOldExpLine)
        return;
    // set exposure
    bSEN_I2C_WriteTry(IMX462_DUMMY_LINE_M, (uint8_t)(((uwTargetExpLine)>>8)&0x00ff), TRY_COUNTS);	
    bSEN_I2C_WriteTry(IMX462_DUMMY_LINE_L, (uint8_t)((uwTargetExpLine)&0x00ff), TRY_COUNTS);     
...
void SEN_SetMirrorFlip(uint8_t ubMirrorEn, uint8_t ubFlipEn)
{
    ...
    bSEN_I2C_Read(0x3007, &xtSENInst.ubImgMode);
    
    if(ubMirrorEn)
        xtSENInst.ubImgMode |=  IMX462_MIRROR;
    else
        xtSENInst.ubImgMode &=  ~IMX462_MIRROR;
    
    if(ubFlipEn)
        xtSENInst.ubImgMode |=  IMX462_FLIP;
    else
        xtSENInst.ubImgMode &=  ~IMX462_FLIP;
...
{
    sensor_cfg.ubSensorType = SEN_IMX462;	
    printf("sensor type is IMX462\r\n");
}
