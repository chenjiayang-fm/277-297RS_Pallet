...
// I2C slave ID can be programmed as 80/81, 84/85, 88/89 or 8C/8D for write and read.
#define SEN_SLAVE_ADDR           (0x40)
// system control registers
/* ID */
#define H63_CHIP_ID_HIGH_ADDR   (0x0A)
#define H63_CHIP_ID_LOW_ADDR    (0x0B)
#define H63_CHIP_ID             (0x0A63)
#define H63_GAIN                (0x00)
#define H63_EXP_L               (0x01)
#define H63_EXP_H               (0x02)
#define H63_FRAME_L			    (0x22)
#define H63_FRAME_H			    (0x23)

#define H63_MIRROR		        (0x1 << 5)
#define H63_FLIP		        (0x1 << 4)
//==============================================================================
// FUNCTION
//==============================================================================
//------------------------------------------------------------------------
