...
/* ID */
#define GC2053_CHIP_ID_HIGH_ADDR   (0xF0)
#define GC2053_CHIP_ID_LOW_ADDR    (0xF1)
#define GC2053_CHIP_ID             (0x2053)
#define GC2053_GAIN_L              (0xB2)
#define GC2053_GAIN_H              (0xB1)
#define GC2053_EXP_L               (0x04)
#define GC2053_EXP_H               (0x03)
#define GC2053_FRAME_L			   (0x42)
#define GC2053_FRAME_H			   (0x41)
#define GC2053_PAGE_SEL			   (0xFE)


#define GC2053_MIRROR		       (0x1 << 0)
#define GC2053_FLIP		           (0x1 << 1)
