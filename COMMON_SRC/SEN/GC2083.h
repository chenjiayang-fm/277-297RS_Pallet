...
//==============================================================================
// Sensor GC2083
// SLAVE_ID is 0x37 [1:7] + [0] r/w
// ID_SEL = 0, slave addr = 0x37.
// ID_SEL = 1, slave addr = 0x3F.
#define SEN_SLAVE_ADDR              (0x37)
// system control registers
/* ID */
#define GC2083_CHIP_ID_HIGH_ADDR   (0x03F0)
#define GC2083_CHIP_ID_LOW_ADDR    (0x03F1)
#define GC2083_CHIP_ID             (0x2083)
#define GC2083_GAIN_L              (0x00B2)
#define GC2083_GAIN_H              (0x00B1)
#define GC2083_EXP_L               (0x0d04)
#define GC2083_EXP_H               (0x0d03)
#define GC2083_FRAME_L			       (0x0d42)
#define GC2083_FRAME_H			       (0x0d41)
//#define GC2083_PAGE_SEL			   (0xFE)


#define GC2083_MIRROR		           (0x1 << 0)
#define GC2083_FLIP		             (0x1 << 1)   
