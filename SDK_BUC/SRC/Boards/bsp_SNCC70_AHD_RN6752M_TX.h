/*!
	...
	\file		bsp_SNCC70_AHD_RN6752M_TX.h
...
*/
//------------------------------------------------------------------------------
#ifndef _BSP_SNCC70_AHD_RN6752M_TX_H_
#define _BSP_SNCC70_AHD_RN6752M_TX_H_

//------------------------------------------------------------------------------
//! CAM Board
//------------------------------------------------------------------------------
#if defined(BSP_SNCC70_AHD_RN6752M_TX_V1)
//------------------------------------------------------------------------------
//! RF 
#ifdef RTC676x
...
//------------------------------------------------------------------------------
//! Sensor GPIO
#define RN6752_RESET_OUT_EN         GPIO->GPIO_OE6
#define RN6752_RESET_OUT            GPIO->GPIO_O6
//------------------------------------------------------------------------------
//! LCD GPIO
//------------------------------------------------------------------------------
//! Audio
...
//! KEY & Auto Pair
#define AUTO_PAIR_PIN               ((GPIO->GPIO_I16)?0:1)
//! GPIO Key Function
#define AKEY_DISABLE
//------------------------------------------------------------------------------
//! BSP RTC Time Select
...
#endif	//!< End of #ifdef BSP_SNCC70_AHD_RN6752M_TX_V1
#endif	//!< End of #ifndef _BSP_SNCC70_AHD_RN6752M_TX_H_
